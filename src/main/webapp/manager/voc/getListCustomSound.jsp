            ...
            <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
                ...
                <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
                    <ul class="nav nav-pills flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link d-flex align-items-center gap-2 active" href="http://localhost/jsp_prj/manager/voc/getListCustomSound.jsp">
                ...
                <table id="non-res">
				        ...
				        <tbody>
				            <tr>
				                ...
				                <td class="title"><a href="http://localhost/jsp_prj/manager/voc/updateCustomSound.jsp">새로운 기능 추가 요청</a></td>
   				            ...
   				            <tr>
				                ...
				                <td class="title"><a href="http://localhost/jsp_prj/manager/voc/updateCustomSound.jsp">가가가각가가가각가ㅏ가가가각ㅁ...</a></td>
				            ...
				            <tr>
				                ...
				                <td class="title"><a href="http://localhost/jsp_prj/manager/voc/updateCustomSound.jsp">ㅇㅅㅇ</a></td>
				            ...
				            <tr>
				                ...
				                <td class="title"><a href="http://localhost/jsp_prj/manager/voc/updateCustomSound.jsp">여긴 인사가 없네요</a></td>
				...
				<table id="res" class="hidden">
				        ...
				        <tbody>
				            <tr>
				                <td class="code">1</td>
				                <td class="subject">불만</td>
				                <td class="title"><a href="http://localhost/jsp_prj/manager/voc/updateCustomSound.jsp">제품 배송이 늦어요</a></td>
				            ...
				            <tr>
				                ...
				                <td class="title"><a href="http://localhost/jsp_prj/manager/voc/updateCustomSound.jsp">환불 절차 문의</a></td>
				            ...
				            <tr>
				                <td class="code">5</td>
				                <td class="subject">불만</td>
				                <td class="title"><a href="http://localhost/jsp_prj/manager/voc/updateCustomSound.jsp">주문한 거랑 달라요</a></td>
				          	...
				          	<tr>
				                ...
				                <td class="title"><a href="http://localhost/jsp_prj/manager/voc/updateCustomSound.jsp">감사합니다</a></td>
				            ...
				            <tr>
				                <td class="code">7</td>
				                <td class="subject">문의</td>
				                <td class="title"><a href="http://localhost/jsp_prj/manager/voc/updateCustomSound.jsp">이거 해주세요</a></td>
				            ...
				            <tr>
				                <td class="code">9</td>
				                <td class="subject">제안사항</td>
				                <td class="title"><a href="http://localhost/jsp_prj/manager/voc/updateCustomSound.jsp">신메뉴 추가 좀요</a></td>

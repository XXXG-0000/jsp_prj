...
<div class="container-fluid">
    <div class="row">
        ...
        //게시판 리스트 구현
                ...
                try{
                	totalCount = diDAO.selectTotalCountIcecream(sVO);
                ...
                try{
                	listBoard = diDAO.selectIcecreamBoard(sVO);//시작 번호, 끝 번호를 사용한 게시글 조회
	...
	게시글의 끝 번호: <c:out value="${ endNum }"/><br> --%>	
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                <h1 class="h2"><strong>아이스크림 메뉴 관리</strong></h1>
            </div>
		<div class="btn-group" role="group" aria-label="Basic radio toggle button group" style="margin-bottom: 30px;">
		  <input type="radio" class="btn-check" name="btnradio" id="btnradio1" autocomplete="off">
		  <label class="btn btn-outline-primary" for="btnradio1"><a href="selectDessertList.jsp" style="color:#0d6efd;">디저트 메뉴</a></label>
		
		  <input type="radio" class="btn-check" name="btnradio" id="btnradio2" autocomplete="off" checked>
		  <label class="btn btn-outline-primary" for="btnradio2"><a href="selectIcecreamList.jsp" style="color:#FFF; font-weight: bold;">아이스크림 메뉴</a></label>
		</div>
		<div id="icecreamList" style="width: 750px; margin: 0 auto;">
		...
		<form action="selectIcecreamList.jsp" method="get" id="searchFrm" name="searchFrm">
		...
		<% sVO.setUrl("selectIcecreamList.jsp"); %>

...
window.onload = function(){
	...
	var positions = [
	    ...
	    {
	        title: '호보식당-제육볶음', 
	        latlng: new kakao.maps.LatLng(37.4980618, 127.0346506)//3d37.4980618!4d127.0346506
	    },
	    {
	        title: '원당뼈다귀감자탕', 
	        latlng: new kakao.maps.LatLng(37.5007938, 127.0339382)//3d37.5007938!4d127.0339382!
	    },
	    {
	        title: '제주은희네해장국',
	        latlng: new kakao.maps.LatLng(37.498189, 127.0315992)//3d37.498189!4d127.0315992
	    }
	];

...
function sendId(){
	...
	//2. 부모창의 HTML Form Control에 설정하고
...
<body>
<div id="wrap">
<div class="agm_cont_wrap" style="display: block;">
          	...
          	<div>
            	<p class="tit">더본 코리아의 [개인정보처리방침]을 안내합니다.</p>
                  ...
                  * 경찰청<br>
                  ...
                  6) ㈜더본코리아는 고객의 실수나 기본적인 인터넷의 위험성 때문에 일어나는 일들에 대해 책임을 지지 않습니다. 고객 스스로가 본인의 개인정보를 보호하기 위해서 자신의 아이디와 비밀번호를 적절하게 관리하고 스스로 책임을 져야 합니다.</p>
                  <br><br>
                  ...
                  * 팩스번호 : 02-512-3864</p>
                  ...
                  7. 영상정보 보호를 위한 기술적․관리적․물리적 조치 : 내부관리계획 수립, 접근통제 및 접근권한 제한, 영상정보의 안전한 저장․전송기술 적용, 처리기록 보관 및 위․변조 방지조치, 보관시설 마련 및 잠금장치 설치 등</p>
                  <br><br>
                  <p class="tit"><span style="font-size: medium; color: #ff0000;"> 16. 시행일자</span></p>
                  <p class="cont">  - 시행일 : 2024년 09월 19일</p><br>
                  <p class="to_top" style="display: block;"><img src="/wp-content/themes/theborn/images/top_icon.png" alt=""></p>
                </div>
              </div>
            </div>
            <!-- //개인정보처리방침 영역 -->

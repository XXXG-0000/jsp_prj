            ...
            <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
                ...
                <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
                    <ul class="nav flex-column">
                       ...
                       <li class="nav-item">
                            <a class="nav-link d-flex align-items-center gap-2" href="drinkProductHub.html">
                                <svg class="bi"><use xlink:href="#cup-hot"/></svg>
                                음료 관리
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link d-flex align-items-center gap-2" href="disertProductHub.html">
...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
	    <h1 class="h2">주문 상태 리스트</h1>
	</div>

    <!-- 탭 메뉴 -->
    <div class="tab-container">
        <div class="tab active" onclick="showTab('received')">수령 완료</div>
    ...
    <table id="received">
        ...
        <tbody>
            <tr>
                ...
                <td>2024-10-11</td>
                <td>4 잔</td>
                <td class="status completed">수령 완료</td>
            </tr>
            <tr>
                <td>ON_002</td>
                <td>아이스 아이스크림</td>
    ...
    <!-- 미수령 주문 -->
    <table id="not-received" class="hidden">
        <thead>
            <tr>
        ...
        <tbody>
            <tr>
                ...
                <td>2024-10-11</td>
                <td>4 잔</td>
                <td class="status pending">미수령</td>
            </tr>
            <tr>
                <td>ON_005</td>
                <td>녹차</td>

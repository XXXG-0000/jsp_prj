...
<h2>GET 방식 HTML Form Control 값 전송</h2>
...
<table>
	...
	<td>
		<textarea name="ta" id="ta" class="inputBox" style="width: 300px; height: 100px"></textarea> <!-- 열림 태그와 닫힘 태그 사이 띄워쓰기 X -->
	</td>
	</tr>
	<tr>
	<td colspan="2">
	<input type="button" value="값 전송" class="btnMy" id="btnGet"/>
...
<h2>POST 방식 HTML Form Control 값 전송</h2><!-- POST 방식은 한글 깨짐 -->

    ...
    <div class="row">
		...
		<div class="plus-container" style="height: 1400px;">
		        ...
		        <form name="drinkFrm" id="drinkFrm" method="post" action="insertDrinkProcess.jsp">
		        	<!-- 음료 번호 -->
		            <label for="drink-num">번호</label>
		            <input type="text" id="drink-num" name="itemNum" placeholder="음료 번호를 입력하세요">
		            ...
		            <fieldset>
		                <legend>카테고리</legend>
		                <label>커피<input type="radio" name="categorieName" value="커피"></label>
		                <label>음료<input type="radio" name="categorieName" value="음료"></label>
		            </fieldset>
		            ...
		            <div id="options-container">
		                ...
		                <div class="option">
		                    ...
		                    <div class="option">
		                   	<input type="radio" name="reuse" value="Y" style="margin-right: 5px;">사용
		                   	</div>
		                   	<div class="option">
		                    <input type="radio" name="reuse" value="N" style="margin-right: 5px;">사용하지 않음
		                    </div>
		                </div>
		            </div>
		            </fieldset>
		    ...
		    <label><input type="radio" name="ingredientFlag" value="Y" onclick="toggleTable(false)"> 미제공</label>

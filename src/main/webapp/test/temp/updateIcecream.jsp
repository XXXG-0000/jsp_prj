    ...
    <div class="row">
        ...
        <form>
            ...
            <div class="image-upload">
                <img id="image-preview" src="http://localhost/jsp_prj/manager/common/image/%EB%85%B8%EB%A7%90%ED%95%9C%EC%86%8C%ED%94%84%ED%8A%B8-3-450x588.png" alt="이미지 미리보기" style="">
			...
			<fieldset>
			    ...
			    <div id="options-container">
			        ...
			        <div class="option">
		                ...
		                <div class="option">
		                <input type="radio" name="addChocolate" value="N" style="margin-right: 5px;"> 아니오
		                </div>
			        </div>
			        <div class="option">
		            ...
		            <div class="option">
		                <input type="radio" name="addStrawberry" value="N" style="margin-right: 5px;"> 아니오
		            </div>
			        </div>
			    </div>
			</fieldset>			

...
<head><script src="/docs/5.3/assets/js/color-modes.js"></script>
    ...
    <style type="text/css">		
		...
		span.res { padding: 5px; color: #000; background-color: #00F200; border-radius: 20px; }
		span.non-res { padding: 5px; color: #000; background-color: #F20000; border-radius: 20px; }
            ...
            <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
                <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
                    <ul class="nav nav-pills flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link d-flex align-items-center gap-2 active" href="http://localhost/jsp_prj/test/chart.umd/getListCustomSound.jsp">

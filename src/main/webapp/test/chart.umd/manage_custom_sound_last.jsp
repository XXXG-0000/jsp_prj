...
<head><script src="/docs/5.3/assets/js/color-modes.js"></script>
    ...
    <style type="text/css">
		...
		span.res { padding: 10px; background-color: #00F200; border-radius: 45% }
		span.non-res { padding: 10px; background-color: #F20000; border-radius: 45% }
        ...
        .search-bar { width: 200px; height: 30px; }
        #subject { width: 150px; height: 30px; }
        #status { width: 150px; height: 30px; }
    </style>
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
				...
				<select id="status">
					...
					<option val="미응답">미응답</option>
					<option val="응답">응답</option>
				</select>

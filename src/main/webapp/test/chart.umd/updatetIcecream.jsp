...
<div class="container-fluid">
    <div class="row">
        ...
        <form>
            ...
            <input type="text" id="drink-name" name="drink-name" placeholder="이름을 입력하세요" value="소프트 아이스크림">
            <label for="drink-name">영어 이름</label>
            <input type="text" id="drink-name" name="drink-name" placeholder="이름을 입력하세요" value="soft icecream">
            ...
            <textarea id="drink-description" name="drink-description" rows="4" placeholder="설명을 입력하세요">입안에서 부드럽게 사르륵 녹는 마성의 아이스크림</textarea>

            <!-- 이미지 추가 -->
            <label for="drink-image">이미지</label>
            <div class="image-upload">
                <img id="image-preview" src="http://localhost/jsp_prj/test/image/%EB%85%B8%EB%A7%90%ED%95%9C%EC%86%8C%ED%94%84%ED%8A%B8-3-450x588.png" alt="이미지 미리보기" style="">
			...
			<fieldset>
			    <legend>카테고리</legend>
			    <label>디저트<input type="radio" name="category" value="tea"></label>
			    <label>아이스크림<input type="radio" name="category" value="smoothie"></label>
			</fieldset>
			...
			<fieldset>
			    ...
			    <table id="nutrition-table">
			        ...
			        <tr>
			            <td>카페인</td>
			            <td><input type="text" value="0 mg"></td>
			        </tr>
			        <tr>
			            <td>칼로리</td>
			            <td><input type="text" value="333 kcal"></td>
			        </tr>
			        <tr>
			            <td>나트륨</td>
			            <td><input type="text" value="70 g"></td>
			        </tr>
			        <tr>
			            <td>당류</td>
			            <td><input type="text" value="20 g"></td>
			        </tr>
			        <tr>
			            <td>포화지방</td>
			            <td><input type="text" value="17 g"></td>
			        </tr>
			        <tr>
			            <td>단백질</td>

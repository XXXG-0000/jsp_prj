...
<div class="container-fluid">
    ...
    <table class="user">
        <thead>
            <tr>
                <th class="code">회원번호</th>
                <th class="id">ID</th>
                <th class="name">이름</th>
                <th class="signUp">가입일</th>
        ...
        <tbody>
            <tr>
                <td class="code" name="code"><a href="modify_member.html">1001</a></td>
                <td class="id" name="id">user1</td>
                <td class="name" name="name">김철수</td>
                <td class="signUp" name="signUp">2024-01-15</td>
                <td class="rank" name="rank">실버</td>
                <td class="status" name="status">활동</td>
                <td class="cell" name="cell">010-1234-5678</td>
            </tr>
            <tr>
                <td class="code" name="code">1002</td>
                <td class="id" name="id">user2</td>
                <td class="name" name="name">이영희</td>
                <td class="signUp" name="signUp">2024-02-20</td>
                <td class="rank" name="rank">골드</td>
                <td class="status" name="status">활동</td>
                <td class="cell" name="cell">010-9876-5432</td>
            </tr>
        </tbody>
    </table>

    ...
    <div class="row">
		...
		<div class="plus-container" style="height: 1400px;">
		        ...
		        <form>
		            ...
		            <input type="text" id="drink-name" name="drink-name" placeholder="음료 이름을 입력하세요">
		            <label for="drink-name">영어 이름</label>
		            <input type="text" id="drink-name" name="drink-name" placeholder="음료 영어 이름을 입력하세요">
		            ...
		            <textarea id="drink-description" name="drink-description" rows="4" placeholder="음료 설명을 입력하세요"></textarea>
		    ...
		    <table id="nutrition-table">
		        ...
		        <tr>
		            ...
		            <!-- 제출 버튼 -->
		            <button type="button" class="btn btn-primary">추가 음료 저장</button>
		        </form>
		    </div>

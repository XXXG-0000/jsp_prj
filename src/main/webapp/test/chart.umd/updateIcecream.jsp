    ...
    <div class="row">
        ...
        <form>
			...
			<fieldset>
			    ...
			    <label><input type="radio" name="nutritional-info" value="yes" id="nutYes" onclick="toggleTable(true)"> 제공</label>
			    <label><input type="radio" name="nutritional-info" value="no" id="nutNo" onclick="toggleTable(false)" checked="checked"> 미제공</label>

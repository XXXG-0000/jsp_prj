...
<div class="container-fluid">
    <div class="row">
        ...
        <form>
            ...
            <input type="text" id="drink-name" name="drink-name" placeholder="이름을 입력하세요" value="크리미슈">
            <label for="drink-name">영어 이름</label>
            <input type="text" id="drink-name" name="drink-name" placeholder="이름을 입력하세요" value="Creamy Choux ">

            <!-- 가격 -->
            <label for="drink-price">가격</label>
            <input type="text" id="drink-price" name="drink-price" placeholder="가격을 입력하세요" value="2,000">

            <!-- 설명 -->
            <label for="drink-description">설명</label>
            <textarea id="drink-description" name="drink-description" rows="4" placeholder="설명을 입력하세요">비스킷과 부드러운 크림의 환상 조합!</textarea>

            <!-- 이미지 추가 -->
            <label for="drink-image">이미지</label>
            <div class="image-upload">
                <img id="image-preview" src="http://localhost/jsp_prj/test/image/%ED%81%AC%EB%A6%AC%EB%AF%B8%EC%8A%88-450x588.png" alt="이미지 미리보기" style="">
			...
			<fieldset>
			    <legend>카테고리</legend>
			    <label>디저트<input type="radio" name="category" value="dessert"></label>
			</fieldset>
			...
			<fieldset>
			    ...
			    <label><input type="radio" name="nutritional-info" value="yes" onclick="toggleTable(true)" disabled="disabled"> 제공</label>
			    <label><input type="radio" name="nutritional-info" value="no" onclick="toggleTable(false)" checked="checked"> 미제공</label>
			</fieldset>
				        ...
				        <button type="button" style="float: none;" class="delete" id="delete">삭제</button>
			        </form>
			    </div>

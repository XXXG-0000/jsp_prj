...
public class OrderVO {
	...
	public String toString() {
		return "OrderVO [cartItemNum=" + cartItemNum + ", cartNum=" + cartNum + ", itemNum=" + itemNum + ", quantity="
				+ quantity + ", orderFlag=" + orderFlag + ", receiptFlag=" + receiptFlag + ", cusId=" + cusId
				+ ", name=" + name + ", iNameK=" + iNameK + ", inputDate=" + inputDate + "]";
	}
